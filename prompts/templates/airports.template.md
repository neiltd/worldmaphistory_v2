# Gemini Research Task: Airports — {{countryName}}
Generated: {{currentDate}}

## Instructions

Research the top {{limit}} most strategically significant international airports in **{{countryName}} ({{countryId}})**.
...
## Required Sources (use at least {{requiredSources}})
...
[
  {
    ...
    "geopoliticalNotes": "1-2 sentences on why this airport matters strategically for {{countryName}} and the {{region}} region",
    "notes": "Operational notes if relevant",
    "attribution": {
      "sources": [
        { "name": "Source Name", "url": "https://...", "accessedAt": "{{currentDate}}" },
        { "name": "Source Name 2", "url": "https://...", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "high",
        "sourceCount": 2,
...
## Save output to
`src/data/raw/airports/{{countryId}}-airports.raw.json`
