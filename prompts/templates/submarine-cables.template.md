# Gemini Research Task: Submarine Internet Cables — {{regionName}}
Generated: {{currentDate}}

## Instructions

Research active and notable submarine internet cables in or crossing **{{regionName}}**.
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "TeleGeography SubmarineCableMap", "url": "https://www.submarinecablemap.com/submarine-cable/CABLE-NAME", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "high",
        "sourceCount": 1,
...
## Save output to
`src/data/raw/submarine-cables/{{regionSlug}}-submarine-cables.raw.json`
