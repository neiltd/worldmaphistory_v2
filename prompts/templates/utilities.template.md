# Gemini Research Task: Country Utility Profile — {{countryName}}
Generated: {{currentDate}}

## Instructions

Research the energy, water, and digital utility profile for **{{countryName}} ({{countryId}})** for the most recent year with complete data (prefer 2022 or 2023).

## Rules

- Return a **valid JSON array** with exactly one object for {{countryName}}
...
## Required Sources (at least {{requiredSources}})
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "IEA World Energy Balances 2023", "url": "https://www.iea.org/data-and-statistics/data-product/world-energy-balances", "accessedAt": "{{currentDate}}" },
        { "name": "WRI Aqueduct 3.0", "url": "https://www.wri.org/aqueduct", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "high",
        "sourceCount": 2,
...
## Save output to
`src/data/raw/utilities/{{countryId}}-utilities.raw.json`
