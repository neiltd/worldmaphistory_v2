# Gemini Research Task: Seaports — {{countryName}}{{regionName}}
Generated: {{currentDate}}

## Instructions

Research the top {{limit}} most strategically significant seaports in **{{countryName}}{{regionName}}**.
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "Source", "url": "https://...", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "medium",
        "sourceCount": 1,
...
## Save output to
`src/data/raw/seaports/{{countryId}}{{regionSlug}}-seaports.raw.json`
