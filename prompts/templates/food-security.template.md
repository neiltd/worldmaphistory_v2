# Gemini Research Task: Food Security — {{countryName}}
Generated: {{currentDate}}

## Instructions

Research the food security profile for **{{countryName}} ({{countryId}})** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/{{countryName}}
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — {{countryName}}", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "{{currentDate}}" },
        { "name": "FAO FAOSTAT", "url": "https://www.fao.org/faostat/en/", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "high",
        "sourceCount": 2,
...
## Save output to
`src/data/raw/food-security/{{countryId}}-food-security.raw.json`
