# Gemini Research Task: Datacenters — {{countryName}}{{regionName}}
Generated: {{currentDate}}

## Instructions

Research the top {{limit}} most strategically significant datacenters in **{{countryName}}{{regionName}}**.
...
[
  {
    "id": "DC-{{countryId}}-CITY-OPERATOR-CODE",
    "name": "Facility Name",
    "countryId": "{{countryId}}",
    "city": "City",
    ...
    "attribution": {
      "sources": [
        { "name": "AWS Global Infrastructure", "url": "https://aws.amazon.com/about-aws/global-infrastructure/regions_az/", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "medium",
        "sourceCount": 1,
...
## Save output to
`src/data/raw/datacenters/{{countryId}}{{regionSlug}}-datacenters.raw.json`
