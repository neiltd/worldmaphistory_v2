# Gemini Research Task: Rail Hubs — {{countryName}}{{regionName}}
Generated: {{currentDate}}

## Instructions

Research the top {{limit}} most strategically significant rail hubs in **{{countryName}}{{regionName}}**.
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "China Railway Express Statistics", "url": "https://english.mofcom.gov.cn/", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "medium",
        "sourceCount": 1,
...
## Save output to
`src/data/raw/rail-hubs/{{countryId}}{{regionSlug}}-rail-hubs.raw.json`
