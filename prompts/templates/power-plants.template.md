# Gemini Research Task: Power Plants — {{countryName}}
Generated: {{currentDate}}

## Instructions

Research major power plants in **{{countryName}} ({{countryId}})**.
...
Limit to the top {{limit}} most strategically significant facilities.
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "Global Energy Monitor", "url": "https://globalenergymonitor.org/...", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "medium",
        "sourceCount": 1,
...
## Save output to
`src/data/raw/power-plants/{{countryId}}-power-plants.raw.json`
