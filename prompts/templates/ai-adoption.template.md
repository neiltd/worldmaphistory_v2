# Gemini Research Task: AI Adoption — {{countryName}}
Generated: {{currentDate}}

## Instructions

Research the AI readiness, adoption, and investment profile for **{{countryName}} ({{countryId}})** for the most recent year available (prefer 2023).
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "Oxford Insights AI Readiness Index 2023", "url": "https://oxfordinsights.com/ai-readiness/ai-readiness-index/", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "medium",
        "sourceCount": 1,
...
## Save output to
`src/data/raw/ai-adoption/{{countryId}}-ai-adoption.raw.json`
