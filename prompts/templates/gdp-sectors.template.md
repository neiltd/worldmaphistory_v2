# Gemini Research Task: GDP Sector Composition — {{countryName}}
Generated: {{currentDate}}

## Instructions

Research the GDP sector composition for **{{countryName}} ({{countryId}})** for the most recent year available (prefer 2022 or 2023).
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "World Bank DataBank 2023", "url": "https://databank.worldbank.org/", "accessedAt": "{{currentDate}}" }
      ],
      "confidence": {
        "confidence": "high",
        "sourceCount": 1,
...
## Save output to
`src/data/raw/gdp-sectors/{{countryId}}-gdp-sectors.raw.json`
