# Gemini Research Task: Datacenters — United Kingdom
Generated: 2026-05-10

## Instructions

Research the top 10 most strategically significant datacenters in **United Kingdom**.
...
## Save output to
`src/data/raw/datacenters/GBR-datacenters.raw.json`
