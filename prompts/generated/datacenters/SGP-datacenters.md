# Gemini Research Task: Datacenters — Singapore
Generated: 2026-05-10

## Instructions

Research the top 10 most strategically significant datacenters in **Singapore**.
...
## Save output to
`src/data/raw/datacenters/SGP-datacenters.raw.json`
