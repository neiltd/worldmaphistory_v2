# Gemini Research Task: Datacenters — United States
Generated: 2026-05-10

## Instructions

Research the top 10 most strategically significant datacenters in **United States**.
...
## Save output to
`src/data/raw/datacenters/USA-datacenters.raw.json`
