# Gemini Research Task: Company Intelligence Profiles — Banks & Financial System
...
1. **JPM** — JPMorgan Chase & Co. (NYSE)
   *Why it matters: Largest US bank — global operations, sanctions compliance leader*

2. **GS** — The Goldman Sachs Group (NYSE)
   *Why it matters: Investment bank — commodities, Russia exit, Middle East growth*

3. **C** — Citigroup Inc. (NYSE)
   *Why it matters: Most international US bank — 160 countries, EM exposure*

4. **MS** — Morgan Stanley (NYSE)
   *Why it matters: Investment banking — China JV complications, Russia exit*

5. **BAC** — Bank of America Corporation (NYSE)
   *Why it matters: US-focused — global trade finance, sanctions exposure*
...
`src/data/raw/companies/banks-companies.raw.json`
