...
1. **XOM** — Exxon Mobil Corporation (NYSE)
   *Why it matters: Largest US oil major — global operations*

2. **CVX** — Chevron Corporation (NYSE)
   *Why it matters: Major US oil — Middle East and Kazakhstan exposure*

3. **SLB** — SLB (Schlumberger) (NYSE)
   *Why it matters: Largest oil services — operates in sanctioned regions*

4. **COP** — ConocoPhillips (NYSE)
   *Why it matters: E&P focused — LNG exports, Alaska and Middle East*

5. **HAL** — Halliburton Company (NYSE)
   *Why it matters: Oil services — Russia exit, Middle East heavy*
...
`src/data/raw/companies/energy-companies.raw.json`
