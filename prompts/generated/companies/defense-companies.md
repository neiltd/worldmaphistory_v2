# Gemini Research Task: Company Intelligence Profiles — Defense & Aerospace
...
1. **LMT** — Lockheed Martin Corporation (NYSE)
   *Why it matters: F-35, Javelin — largest defense contractor, rare earth exposure*

2. **RTX** — RTX Corporation (Raytheon) (NYSE)
   *Why it matters: Missiles, Stinger, Patriot — Ukraine/Taiwan demand surge*

3. **NOC** — Northrop Grumman Corporation (NYSE)
   *Why it matters: B-21, Space systems — classified programs exposure*

4. **GD** — General Dynamics Corporation (NYSE)
   *Why it matters: Gulfstream, submarines, Abrams — international sales*

5. **BA** — The Boeing Company (NYSE)
   *Why it matters: Defense + commercial aviation — China delivery freeze*
...
`src/data/raw/companies/defense-companies.raw.json`
