# Gemini Research Task: Company Intelligence Profiles — Commodities
...
1. **NEM** — Newmont Corporation (NYSE)
   *Why it matters: Largest gold miner — operations in 9 countries*

2. **FCX** — Freeport-McMoRan Inc. (NYSE)
   *Why it matters: Largest copper miner — Indonesia, US, DRC, Peru*

3. **GOLD** — Barrick Gold Corporation (NYSE)
   *Why it matters: Major gold miner — Africa, Middle East, Americas*

4. **AA** — Alcoa Corporation (NYSE)
   *Why it matters: Aluminum — energy-intensive, Russia sanctions impact*

5. **MOS** — The Mosaic Company (NYSE)
   *Why it matters: Fertilizer — Russia/Belarus sanctions cut global supply*
...
`src/data/raw/companies/commodities-companies.raw.json`
