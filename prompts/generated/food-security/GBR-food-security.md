# Gemini Research Task: Food Security — United Kingdom
Generated: 2026-05-10

## Instructions

Research the food security profile for **United Kingdom (GBR)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/United Kingdom
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — United Kingdom", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/GBR-food-security.raw.json`
