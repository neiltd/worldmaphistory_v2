# Gemini Research Task: Food Security — Vietnam
Generated: 2026-05-10

## Instructions

Research the food security profile for **Vietnam (VNM)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Vietnam
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Vietnam", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/VNM-food-security.raw.json`
