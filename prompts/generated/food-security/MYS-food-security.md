# Gemini Research Task: Food Security — Malaysia
Generated: 2026-05-10

## Instructions

Research the food security profile for **Malaysia (MYS)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Malaysia
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Malaysia", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/MYS-food-security.raw.json`
