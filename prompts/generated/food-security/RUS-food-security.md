# Gemini Research Task: Food Security — Russia
Generated: 2026-05-10

## Instructions

Research the food security profile for **Russia (RUS)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Russia
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Russia", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/RUS-food-security.raw.json`
