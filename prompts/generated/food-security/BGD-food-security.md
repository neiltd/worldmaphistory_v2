# Gemini Research Task: Food Security — Bangladesh
Generated: 2026-05-10

## Instructions

Research the food security profile for **Bangladesh (BGD)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Bangladesh
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Bangladesh", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/BGD-food-security.raw.json`
