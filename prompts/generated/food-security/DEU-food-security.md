# Gemini Research Task: Food Security — Germany
Generated: 2026-05-10

## Instructions

Research the food security profile for **Germany (DEU)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Germany
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Germany", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/DEU-food-security.raw.json`
