# Gemini Research Task: Food Security — China
Generated: 2026-05-10

## Instructions

Research the food security profile for **China (CHN)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/China
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — China", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/CHN-food-security.raw.json`
