# Gemini Research Task: Food Security — Thailand
Generated: 2026-05-10

## Instructions

Research the food security profile for **Thailand (THA)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Thailand
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Thailand", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/THA-food-security.raw.json`
