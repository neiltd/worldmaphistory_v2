# Gemini Research Task: Food Security — South Africa
Generated: 2026-05-10

## Instructions

Research the food security profile for **South Africa (ZAF)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/South Africa
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — South Africa", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/ZAF-food-security.raw.json`
