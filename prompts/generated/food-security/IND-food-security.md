# Gemini Research Task: Food Security — India
Generated: 2026-05-10

## Instructions

Research the food security profile for **India (IND)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/India
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — India", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/IND-food-security.raw.json`
