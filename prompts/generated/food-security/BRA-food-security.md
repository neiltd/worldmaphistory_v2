# Gemini Research Task: Food Security — Brazil
Generated: 2026-05-10

## Instructions

Research the food security profile for **Brazil (BRA)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Brazil
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Brazil", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/BRA-food-security.raw.json`
