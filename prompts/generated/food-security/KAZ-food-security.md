# Gemini Research Task: Food Security — Kazakhstan
Generated: 2026-05-10

## Instructions

Research the food security profile for **Kazakhstan (KAZ)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Kazakhstan
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Kazakhstan", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/KAZ-food-security.raw.json`
