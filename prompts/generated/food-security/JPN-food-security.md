# Gemini Research Task: Food Security — Japan
Generated: 2026-05-10

## Instructions

Research the food security profile for **Japan (JPN)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Japan
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Japan", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/JPN-food-security.raw.json`
