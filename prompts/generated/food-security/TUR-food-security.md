# Gemini Research Task: Food Security — Turkey
Generated: 2026-05-10

## Instructions

Research the food security profile for **Turkey (TUR)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Turkey
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Turkey", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/TUR-food-security.raw.json`
