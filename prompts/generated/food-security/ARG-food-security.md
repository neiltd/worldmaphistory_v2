# Gemini Research Task: Food Security — Argentina
Generated: 2026-05-10

## Instructions

Research the food security profile for **Argentina (ARG)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Argentina
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Argentina", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/ARG-food-security.raw.json`
