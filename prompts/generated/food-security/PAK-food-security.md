# Gemini Research Task: Food Security — Pakistan
Generated: 2026-05-10

## Instructions

Research the food security profile for **Pakistan (PAK)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Pakistan
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Pakistan", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/PAK-food-security.raw.json`
