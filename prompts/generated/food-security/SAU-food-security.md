# Gemini Research Task: Food Security — Saudi Arabia
Generated: 2026-05-10

## Instructions

Research the food security profile for **Saudi Arabia (SAU)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Saudi Arabia
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Saudi Arabia", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/SAU-food-security.raw.json`
