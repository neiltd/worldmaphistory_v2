# Gemini Research Task: Food Security — Ethiopia
Generated: 2026-05-10

## Instructions

Research the food security profile for **Ethiopia (ETH)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Ethiopia
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Ethiopia", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/ETH-food-security.raw.json`
