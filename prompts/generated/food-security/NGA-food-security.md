# Gemini Research Task: Food Security — Nigeria
Generated: 2026-05-10

## Instructions

Research the food security profile for **Nigeria (NGA)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Nigeria
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Nigeria", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/NGA-food-security.raw.json`
