# Gemini Research Task: Food Security — Mexico
Generated: 2026-05-10

## Instructions

Research the food security profile for **Mexico (MEX)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Mexico
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Mexico", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/MEX-food-security.raw.json`
