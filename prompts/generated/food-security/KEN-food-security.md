# Gemini Research Task: Food Security — Kenya
Generated: 2026-05-10

## Instructions

Research the food security profile for **Kenya (KEN)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Kenya
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Kenya", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/KEN-food-security.raw.json`
