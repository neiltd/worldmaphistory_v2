# Gemini Research Task: Food Security — Poland
Generated: 2026-05-10

## Instructions

Research the food security profile for **Poland (POL)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Poland
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Poland", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/POL-food-security.raw.json`
