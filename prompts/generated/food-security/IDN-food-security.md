# Gemini Research Task: Food Security — Indonesia
Generated: 2026-05-10

## Instructions

Research the food security profile for **Indonesia (IDN)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Indonesia
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Indonesia", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/IDN-food-security.raw.json`
