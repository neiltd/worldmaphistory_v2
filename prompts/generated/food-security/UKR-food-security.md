# Gemini Research Task: Food Security — Ukraine
Generated: 2026-05-10

## Instructions

Research the food security profile for **Ukraine (UKR)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Ukraine
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Ukraine", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/UKR-food-security.raw.json`
