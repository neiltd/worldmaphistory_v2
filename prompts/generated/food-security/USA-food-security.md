# Gemini Research Task: Food Security — United States
Generated: 2026-05-10

## Instructions

Research the food security profile for **United States (USA)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/United States
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — United States", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/USA-food-security.raw.json`
