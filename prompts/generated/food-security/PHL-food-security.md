# Gemini Research Task: Food Security — Philippines
Generated: 2026-05-10

## Instructions

Research the food security profile for **Philippines (PHL)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Philippines
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Philippines", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/PHL-food-security.raw.json`
