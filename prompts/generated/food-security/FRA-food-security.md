# Gemini Research Task: Food Security — France
Generated: 2026-05-10

## Instructions

Research the food security profile for **France (FRA)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/France
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — France", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/FRA-food-security.raw.json`
