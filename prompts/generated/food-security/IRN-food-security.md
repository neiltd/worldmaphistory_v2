# Gemini Research Task: Food Security — Iran
Generated: 2026-05-10

## Instructions

Research the food security profile for **Iran (IRN)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/Iran
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — Iran", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/IRN-food-security.raw.json`
