# Gemini Research Task: Food Security — South Korea
Generated: 2026-05-10

## Instructions

Research the food security profile for **South Korea (KOR)** using the Global Food Security Index (GFSI) and FAO data.
...
- World Food Programme: wfp.org/countries/South Korea
...
[
  {
    ...
    "attribution": {
      "sources": [
        { "name": "GFSI 2023 — South Korea", "url": "https://impact.economist.com/sustainability/project/food-security-index/", "accessedAt": "2026-05-10" },
...
## Save output to
`src/data/raw/food-security/KOR-food-security.raw.json`
