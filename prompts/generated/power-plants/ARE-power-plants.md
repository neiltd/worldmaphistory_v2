# Gemini Research Task: Power Plants — United Arab Emirates
Generated: 2026-05-10

## Instructions

Research major power plants in **United Arab Emirates (ARE)**.
...
## Save output to
`src/data/raw/power-plants/ARE-power-plants.raw.json`
