# Gemini Research Task: Airports — India
Generated: 2026-05-10

## Instructions

Research the top 10 most strategically significant international airports in **India (IND)**.
...
[
  {
    ...
    "geopoliticalNotes": "1-2 sentences on why this airport matters strategically for India and the South Asia region",
...
## Save output to
`src/data/raw/airports/IND-airports.raw.json`
