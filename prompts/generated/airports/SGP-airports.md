# Gemini Research Task: Airports — Singapore
Generated: 2026-05-10

## Instructions

Research the top 10 most strategically significant international airports in **Singapore (SGP)**.
...
[
  {
    ...
    "geopoliticalNotes": "1-2 sentences on why this airport matters strategically for Singapore and the Southeast Asia region",
...
## Save output to
`src/data/raw/airports/SGP-airports.raw.json`
