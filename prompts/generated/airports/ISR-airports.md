# Gemini Research Task: Airports — Israel
Generated: 2026-05-10

## Instructions

Research the top 10 most strategically significant international airports in **Israel (ISR)**.
...
[
  {
    ...
    "geopoliticalNotes": "1-2 sentences on why this airport matters strategically for Israel and the Middle East region",
...
## Save output to
`src/data/raw/airports/ISR-airports.raw.json`
