# Gemini Research Task: Airports — Germany
Generated: 2026-05-10

## Instructions

Research the top 10 most strategically significant international airports in **Germany (DEU)**.
...
[
  {
    ...
    "geopoliticalNotes": "1-2 sentences on why this airport matters strategically for Germany and the Europe region",
...
## Save output to
`src/data/raw/airports/DEU-airports.raw.json`
