# Gemini Research Task: AI Adoption — Israel
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **Israel (ISR)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/ISR-ai-adoption.raw.json`
