# Gemini Research Task: AI Adoption — United Kingdom
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **United Kingdom (GBR)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/GBR-ai-adoption.raw.json`
