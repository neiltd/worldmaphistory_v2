# Gemini Research Task: AI Adoption — United Arab Emirates
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **United Arab Emirates (ARE)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/ARE-ai-adoption.raw.json`
