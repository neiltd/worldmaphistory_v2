# Gemini Research Task: AI Adoption — Russia
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **Russia (RUS)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/RUS-ai-adoption.raw.json`
