# Gemini Research Task: AI Adoption — Japan
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **Japan (JPN)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/JPN-ai-adoption.raw.json`
