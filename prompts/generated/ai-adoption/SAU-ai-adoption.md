# Gemini Research Task: AI Adoption — Saudi Arabia
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **Saudi Arabia (SAU)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/SAU-ai-adoption.raw.json`
