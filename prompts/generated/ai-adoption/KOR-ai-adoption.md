# Gemini Research Task: AI Adoption — South Korea
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **South Korea (KOR)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/KOR-ai-adoption.raw.json`
