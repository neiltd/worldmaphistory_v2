# Gemini Research Task: AI Adoption — France
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **France (FRA)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/FRA-ai-adoption.raw.json`
