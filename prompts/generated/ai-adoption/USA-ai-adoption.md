# Gemini Research Task: AI Adoption — United States
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **United States (USA)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/USA-ai-adoption.raw.json`
