# Gemini Research Task: AI Adoption — Turkey
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **Turkey (TUR)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/TUR-ai-adoption.raw.json`
