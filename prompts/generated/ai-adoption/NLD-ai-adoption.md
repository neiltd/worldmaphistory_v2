# Gemini Research Task: AI Adoption — Netherlands
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **Netherlands (NLD)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/NLD-ai-adoption.raw.json`
