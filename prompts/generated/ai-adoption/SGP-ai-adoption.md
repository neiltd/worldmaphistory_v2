# Gemini Research Task: AI Adoption — Singapore
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **Singapore (SGP)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/SGP-ai-adoption.raw.json`
