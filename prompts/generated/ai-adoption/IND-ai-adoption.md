# Gemini Research Task: AI Adoption — India
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **India (IND)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/IND-ai-adoption.raw.json`
