# Gemini Research Task: AI Adoption — Brazil
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **Brazil (BRA)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/BRA-ai-adoption.raw.json`
