# Gemini Research Task: AI Adoption — China
Generated: 2026-05-10

## Instructions

Research the AI readiness, adoption, and investment profile for **China (CHN)** for the most recent year available (prefer 2023).
...
## Save output to
`src/data/raw/ai-adoption/CHN-ai-adoption.raw.json`
