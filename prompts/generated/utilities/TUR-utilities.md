# Gemini Research Task: Country Utility Profile — Turkey
Generated: 2026-05-10

## Instructions

Research the energy, water, and digital utility profile for **Turkey (TUR)** for the most recent year with complete data (prefer 2022 or 2023).

## Rules

- Return a **valid JSON array** with exactly one object for Turkey
...
## Save output to
`src/data/raw/utilities/TUR-utilities.raw.json`
