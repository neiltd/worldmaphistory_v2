# Gemini Research Task: Country Utility Profile — United Arab Emirates
Generated: 2026-05-10

## Instructions

Research the energy, water, and digital utility profile for **United Arab Emirates (ARE)** for the most recent year with complete data (prefer 2022 or 2023).

## Rules

- Return a **valid JSON array** with exactly one object for United Arab Emirates
...
## Save output to
`src/data/raw/utilities/ARE-utilities.raw.json`
