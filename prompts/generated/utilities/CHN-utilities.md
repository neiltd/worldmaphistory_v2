# Gemini Research Task: Country Utility Profile — China
Generated: 2026-05-10

## Instructions

Research the energy, water, and digital utility profile for **China (CHN)** for the most recent year with complete data (prefer 2022 or 2023).

## Rules

- Return a **valid JSON array** with exactly one object for China
...
## Save output to
`src/data/raw/utilities/CHN-utilities.raw.json`
