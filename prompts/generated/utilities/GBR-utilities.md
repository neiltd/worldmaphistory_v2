# Gemini Research Task: Country Utility Profile — United Kingdom
Generated: 2026-05-10

## Instructions

Research the energy, water, and digital utility profile for **United Kingdom (GBR)** for the most recent year with complete data (prefer 2022 or 2023).

## Rules

- Return a **valid JSON array** with exactly one object for United Kingdom
...
## Save output to
`src/data/raw/utilities/GBR-utilities.raw.json`
