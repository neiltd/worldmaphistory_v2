# Gemini Research Task: Country Utility Profile — France
Generated: 2026-05-10

## Instructions

Research the energy, water, and digital utility profile for **France (FRA)** for the most recent year with complete data (prefer 2022 or 2023).

## Rules

- Return a **valid JSON array** with exactly one object for France
...
## Save output to
`src/data/raw/utilities/FRA-utilities.raw.json`
