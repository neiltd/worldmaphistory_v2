# Gemini Research Task: Country Utility Profile — Indonesia
Generated: 2026-05-10

## Instructions

Research the energy, water, and digital utility profile for **Indonesia (IDN)** for the most recent year with complete data (prefer 2022 or 2023).

## Rules

- Return a **valid JSON array** with exactly one object for Indonesia
...
## Save output to
`src/data/raw/utilities/IDN-utilities.raw.json`
