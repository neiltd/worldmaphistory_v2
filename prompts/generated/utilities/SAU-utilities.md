# Gemini Research Task: Country Utility Profile — Saudi Arabia
Generated: 2026-05-10

## Instructions

Research the energy, water, and digital utility profile for **Saudi Arabia (SAU)** for the most recent year with complete data (prefer 2022 or 2023).

## Rules

- Return a **valid JSON array** with exactly one object for Saudi Arabia
...
## Save output to
`src/data/raw/utilities/SAU-utilities.raw.json`
