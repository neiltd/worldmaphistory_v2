# Gemini Research Task: Country Utility Profile — Russia
Generated: 2026-05-10

## Instructions

Research the energy, water, and digital utility profile for **Russia (RUS)** for the most recent year with complete data (prefer 2022 or 2023).

## Rules

- Return a **valid JSON array** with exactly one object for Russia
...
## Save output to
`src/data/raw/utilities/RUS-utilities.raw.json`
