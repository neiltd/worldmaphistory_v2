# Gemini Research Task: GDP Sector Composition — Japan
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **Japan (JPN)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/JPN-gdp-sectors.raw.json`
