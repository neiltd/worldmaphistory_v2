# Gemini Research Task: GDP Sector Composition — Pakistan
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **Pakistan (PAK)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/PAK-gdp-sectors.raw.json`
