# Gemini Research Task: GDP Sector Composition — Argentina
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **Argentina (ARG)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/ARG-gdp-sectors.raw.json`
