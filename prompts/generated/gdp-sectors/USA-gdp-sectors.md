# Gemini Research Task: GDP Sector Composition — United States
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **United States (USA)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/USA-gdp-sectors.raw.json`
