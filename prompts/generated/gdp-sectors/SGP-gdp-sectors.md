# Gemini Research Task: GDP Sector Composition — Singapore
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **Singapore (SGP)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/SGP-gdp-sectors.raw.json`
