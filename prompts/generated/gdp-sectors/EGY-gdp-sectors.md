# Gemini Research Task: GDP Sector Composition — Egypt
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **Egypt (EGY)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/EGY-gdp-sectors.raw.json`
