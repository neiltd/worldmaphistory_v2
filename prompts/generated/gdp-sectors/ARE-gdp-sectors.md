# Gemini Research Task: GDP Sector Composition — United Arab Emirates
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **United Arab Emirates (ARE)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/ARE-gdp-sectors.raw.json`
