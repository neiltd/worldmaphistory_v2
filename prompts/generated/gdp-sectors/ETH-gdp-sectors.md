# Gemini Research Task: GDP Sector Composition — Ethiopia
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **Ethiopia (ETH)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/ETH-gdp-sectors.raw.json`
