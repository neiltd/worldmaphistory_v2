# Gemini Research Task: GDP Sector Composition — United Kingdom
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **United Kingdom (GBR)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/GBR-gdp-sectors.raw.json`
