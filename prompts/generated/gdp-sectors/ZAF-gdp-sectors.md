# Gemini Research Task: GDP Sector Composition — South Africa
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **South Africa (ZAF)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/ZAF-gdp-sectors.raw.json`
