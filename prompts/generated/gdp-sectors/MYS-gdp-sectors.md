# Gemini Research Task: GDP Sector Composition — Malaysia
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **Malaysia (MYS)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/MYS-gdp-sectors.raw.json`
