# Gemini Research Task: GDP Sector Composition — Saudi Arabia
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **Saudi Arabia (SAU)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/SAU-gdp-sectors.raw.json`
