# Gemini Research Task: GDP Sector Composition — Kenya
Generated: 2026-05-10

## Instructions

Research the GDP sector composition for **Kenya (KEN)** for the most recent year available (prefer 2022 or 2023).
...
## Save output to
`src/data/raw/gdp-sectors/KEN-gdp-sectors.raw.json`
